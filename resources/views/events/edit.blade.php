        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('events.update', $event) }}"
                    onsubmit="return confirm('Are you sure you want to modify this event?');" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('description', $event->description) }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="type" name="type" onchange="toggleEventFields()"
                            ...
                            <option value="one-off" {{ old('type', $event->type) === 'one-off' ? 'selected' : '' }}>
                                One-off Event</option>
                            <option value="recurring" {{ old('type', $event->type) === 'recurring' ? 'selected' : '' }}>
                    ...
                    <div id="recurring_fields" class="mb-4 bg-gray-50 p-4 rounded border" style="display: none;">
                        <label for="recurring_schedule" class="block text-gray-700 font-bold mb-2">Schedule
                            Pattern</label>
