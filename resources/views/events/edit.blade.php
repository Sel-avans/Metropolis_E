            ...
            @if ($errors->any())
                ...
                <form method="POST" action="{{ route('events.update', $event) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $event->name) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
