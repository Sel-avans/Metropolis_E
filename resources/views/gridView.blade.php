    ...
    <div class="flex gap-4">
        ...
        <div class="flex flex-col mx-auto">
            ...
            <div class="w-auto p-6">
                <h1 class="text-2xl font-bold mb-4 dark:text-teal-500">City Grid (3x4)</h1>
            ...
            {{-- QoL Score --}}
            <div class="w-auto h-min border-4 border-gray-400 dark:bg-indigo-800 dark:border-teal-600 rounded-md p-6">
